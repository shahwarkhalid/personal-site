...
import ProfileImage from '../../../content/images/personal-web.jpg'
                    ...
                    <Row>
                            ...
                            <AnimationContainer animation="fadeIn">
                                <ImageContainer>
                                    <RevealContent delay={500}>
                                        <Image src={ProfileImage} alt="about" />
                                    </RevealContent>
                                </ImageContainer>
                            </AnimationContainer>
                        </LeftCol>
                        <Col md={6}>
                            <AnimationContainer animation="fadeIn">
                                ...
                                <Separator />
                                <Text>
                                    I believe in the world in which majority of the people wake up every single morning and inspire to go to work. They feel safe when they're there and they come home fulfilled at the end of the day. And for that I strive everyday, however I can. Moreover, I firmly believe in empowering others by any mean possible.
                                </Text>
                                <TabsPart />
                            </AnimationContainer>
                        </Col>
                    ...
                    <Container>
                        <Row>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={10} duration={5} delay={1000} symbol="+" text="Clients Worked With" animation={true} />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            <Col md={4}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={11} duration={5} delay={1000} text="Projects Completed" animation={true} />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            {/* <Col md={3}>
