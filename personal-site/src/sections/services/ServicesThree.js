...
import WebIcon from '../../../content/images/icons/web-icon.png'
import UiIcon from '../../../content/images/icons/ui-icon.png'
import DiscussIcon from '../../../content/images/icons/discuss-icon.png'
...
class ServicesOne extends React.Component {
    ...
    render() {
        const Section = styled.section`
            ...
            background-image: url(https://www.itl.cat/pngfile/big/46-466571_black-geometric-wallpaper-architecture.jpg);
                        ...
                        <Col md={4}>
                                <AnimationContainer animation="fadeInDown"  delay={400}>
                                    <ServiceElement>
                                        ...
                                        <ServiceList>
                                            <ServiceListElement>
                                                I work with the latest tech stacks to engineer front-end and back-end solutions, and do everything from single page progressive web applications in React and Angular, to multi-tier services in Ruby, deployed on AWS and Heroku.
                                            </ServiceListElement>
                                        </ServiceList>
                                    </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeInLeft" delay={200}>
                                        <ServiceElement>
                                            <ServiceIcon>
                                                    <img src={UiIcon} alt="Mobile App Development" />
                                            </ServiceIcon>
                                            <ServiceHeading>
                                                UI/UX Design
                                            </ServiceHeading>
                                            ...
                                            <ServiceList>
                                                <ServiceListElement>
                                                    Design has to tell your story. We strive to create sites and apps which will visually appeal to your target audience and reflect your brand identity.
                                                </ServiceListElement>
                                            </ServiceList>
                                        </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeInRight" delay={600}>
                                    <ServiceElement>
                                        <ServiceIcon>
                                                <img src={DiscussIcon} alt="Mobile App Development" />
                                        </ServiceIcon>
                                        <ServiceHeading>
                                            Consultancy
                                        </ServiceHeading>
                                        ...
                                        <ServiceList>
                                            <ServiceListElement>
                                                I offer premium IT consultancy services to take your business to new heights. My experienced tech consultants provide high-end IT consultancy services that take your business to leading position in the market with strong IT support
                                            </ServiceListElement>
                                        </ServiceList>
                                    </ServiceElement>
                                </AnimationContainer>
