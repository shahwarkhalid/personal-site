...
class HeroPersonal extends React.Component {
    ...
    render() {
        ...
        const Section = styled.section`
            ...
            background-image: url(https://us.123rf.com/450wm/sd10686/sd106861603/sd10686160300049/53241696-black-grey-gradient-abstract-geometric-triangular-polygon-style-illustration-graphic-background.jpg?ver=6);
            ...
            <Section id="home">
                <Overlay style={{height: `${this.state.width > 500 ? this.state.height : 350}px`}}>
                    <HeadingBox  className="parallax-hero-item animate">
                        ...
                        <Resume href="https://hamzagit19.github.io/">
                            Download Resume
                        </Resume>
                    </HeadingBox>
                    {this.shapes()}
